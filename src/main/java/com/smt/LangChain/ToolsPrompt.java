...
public class ToolsPrompt {
    ...
    public final static String chatPrompt = "你是一个AI助手,你根据用户的提问输出简单的回答。\n" +
            ...
            "1、不能提供负面、消极的引导。\n" +
            "2、回答要尽可能简单\n" +
            "3、不能输出负面消极的内容，例如色情，暴力，犯罪等。";


    public final static String readFilePrompt = "功能描述:你是一个基于用户提供的信息和用户请求输出任何可能需要参考的文件的完整路径\n" +
            "#核心任务\n" +
            "1、你需要基于用户提供的信息知道用户当前路径下所有的文件名和文件路径\n" +
            "2、你需要基于用户当前的请求去总结你可能需要参考当前路径下的文件\n" +
            "3、你需要输出你要参考的文件的完整路径\n" +
            "#相关限制\n" +
            "1、你输出的文件路径必须在用户提供的文件目录下";
